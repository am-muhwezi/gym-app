...
const DumbbellIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8 text-brand-primary"><path d="M14.4 14.4 9.6 9.6"/><path d="M18 18_4-4_4Z"/><path d="m18 6-4 4"/><path d="m6 18-4-4"/><path d="m12 12 5 5"/><path d="M22 12h-5"/><path d="M9 12H4"/><path d="M12 22v-5"/><path d="M12 9V4"/></svg>
);
